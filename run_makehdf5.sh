...
# sbatch run_g4.sh <num_events_to_gen> <path/to/reco/files> <hdf5_maker.fcl>
...
singularity exec  --bind /home/$USERNAME,/scratch/$USERNAME,/cvmfs,/project/6071458 /project/6071458/neutrino_ml/trjsl7  `pwd`/makehdf5.sh ${NUM_EVENTS} ${RUN_NUM} ${IN_FILE_PATH} ${FCL_FILE_NAME}
